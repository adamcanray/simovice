                        ...
                        <div class="grid grid-cols-6 gap-4 items-center">
                            <div class="col-span-6">
                                <form class="flex shadow-lg sm:rounded-lg" @submit.prevent="searchVo">
                                    <input
                                        class="h-10 w-full sm:rounded-l-lg sm:text-sm border-gray-200"
                                        :class="{'focus:ring-red-500 focus:border-red-500 border-red-500': searchError, 'focus:ring-blue-500 focus:border-blue-500': !searchError}"
                                        type="text"
                                        v-model="search"
                                ...
                                <span v-if="searchError" class="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                                    Kode tidak sesuai, masukan kode yang sesuai
                                </span>
                                <span v-else class="flex items-center font-medium tracking-wide text-blue-500 text-xs mt-1 ml-1">
                        ...
                        <div class="grid grid-cols-12 gap-4 items-start">
                            <div class="col-span-4">
                                <div class="grid grid-cols-6 gap-4 items-start">
                                    <div v-if="company.hasOwnProperty('id')" class="col-span-6">
                            ...
                            <div v-if="company.hasOwnProperty('id')" class="col-span-8 bg-white overflow-hidden shadow-lg sm:rounded-lg">
...
<script>
    ...
    export default {
        ...
        methods:{
            async searchVo() {
                try{
                    this.searchRequest = true // request
